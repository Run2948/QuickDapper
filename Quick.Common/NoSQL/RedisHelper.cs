...
namespace Quick.Common.NoSQL
{
    ...
    public class RedisHelper : Disposable
    {
        ...
        public static string DefaultConnectionString { get; set; } = ConfigurationManager.ConnectionStrings["RedisHosts"]?.ConnectionString ?? "127.0.0.1:6379,allowadmin=true,password=123456,abortConnect=false,connectTimeout=1000,connectRetry=1,syncTimeout=20000";
