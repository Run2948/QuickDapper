...
* 创 建 者：Qing
* 创建时间：2019/06/23 19:12:07
* CLR 版本：4.0.30319.42000
* 保存的文件名：BaseController
* 文件版本：V1.0.0.0
*
* 功能描述：N/A 
*
...
using Quick.Common.Mvc.Mime;
using System.Web.Mvc;

namespace Quick.Common.Mvc.Controllers
{
    public class BaseController : Controller
    {
        ...
        protected ResultInfo SucResp(string msg)
        {
        ...
        protected string GetCurrentIp()
        {
            ...
            try
            {
                userIp = !string.IsNullOrEmpty(Request.ServerVariables["HTTP_X_FORWARDED_FOR"]) ? Request.ServerVariables["REMOTE_ADDR"] : Request.ServerVariables["HTTP_X_FORWARDED_FOR"];
